...
<style>
	...
	.status_1 {
		background: url('<?= G5_THEME_URL ?>/_images/okay_icon.png') no-repeat center left;
		background-size: 13px;
		padding-left: 10px;
	}

	.status_2 {
		background: url('<?= G5_THEME_URL ?>/_images/x_icon.png') no-repeat center left;
		background-size: 13px;
		padding-left: 10px;
	}
...
<script>
	$(function() {
		...
		$('.chage_pw_pop1 .save').click(function() {
			...
			// 	dialogModal('입력확인', '<p>4~8자 이내 영문,숫자,특수문자 조합을 해주세요.</p>', 'failed', false);
			// 	return false;
			// }

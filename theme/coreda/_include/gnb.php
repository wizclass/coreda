		...
		<? if (!$menubar) { ?>
			<nav class="left_gnbWrap">
				...
				<ul class="left_gnb">
					...
					<? } ?>
					<!-- <li class="mining_icon <? if ($_GET['id'] === 'mining') {
																				echo 'active';
																			} ?>">
			...
			<li class="mypool_icon <? if ($_GET['id'] === 'mypool') {
																echo 'active';
															} ?>">
			...
			-->
					<? if ($nw['nw_purchase'] == 'Y') { ?>
						<li class="upstairs_icon <? if ($_GET['id'] === 'upstairs') {
																				echo 'active';
																			} ?>">
					...
					<? } ?>
					<li class="bonus_history_icon <? if ($_GET['id'] === 'bonus_history') {
																					echo 'active';
																				} ?>">
			...
			<li class="center_page_icon <? if ($_GET['id'] === 'center_page') {
																		echo 'active';
																	} ?>">
			...
			-->
					...
					<? if ($member['mb_level'] > 0) { ?>
						<li class="recommend_icon <? if ($_GET['id'] === 'structure') {
																				echo 'active';
																			} ?>">
			...
			<li class="support_icon <? //if($_GET['id'] === 'binary2') {echo 'active';}
				...
				<a href="/page.php?id=binary2">
					...
					<li class="question_icon <? if ($_GET['id'] === 'support_center' || $_GET['id'] === 'support_center.admin') {
																			echo 'active';
																		} ?>">
					...
					<li class="reffer_icon <? if ($_GET['id'] === 'referral_link') {
																		echo 'active';
																	} ?>">

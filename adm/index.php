        ...
        <table>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        <td class="td_category"><?= CONFIG_TITLE ?></td>
                        <td class="td_category"><?php echo cut_str($row['bo_subject'], 20) ?></td>
                        <td><a href="<?php echo G5_BBS_DIR . "/board.php?bo_table=" . $row['bo_table'] . "&wr_id=" . $row['wr_id'] ?><?php echo $comment_link ?>"><?php echo $comment ?><?php echo conv_subject($row2['wr_subject'], 100) ?></a></td>
                        <td class="td_mbname">
